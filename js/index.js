    ...
    `
        <div id="item" class="item">
            ...
            <div class="news_box border_radius">
                <img class="image" src="https://images.ctfassets.net/hrltx12pl8hq/28ECAQiPJZ78hxatLTa7Ts/2f695d869736ae3b0de3e56ceaca3958/free-nature-images.jpg?fit=fill&w=1200&h=630" alt="" />
                <h3>
                    ${item.title}
                </h3>
            </div>
